...
import { useGetDashboardComingSoonCopyQuery } from "@/lib/api/baseApi";
import { storeRoutes } from "@/lib/routes/store";

/**
 * Full-page “coming soon” for routes outside the storefront shell (e.g. `/dashboard`).
 */
export function ComingSoonPage() {
  const { data, isFetching } = useGetDashboardComingSoonCopyQuery();
